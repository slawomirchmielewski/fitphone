...
class MeasurementsWeekView extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    ...
    return Page(
      pageName: "hello",
      appBarTitle: Text("Week Body Measurements"),
      scrollable: true,
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: Text("WEEK ACTIVITY",style: Theme.of(context).textTheme.body1.copyWith(
              color: Colors.grey
            ),),
          ),
          SizedBox(height: 16),
          ListView.builder(
            ...
            itemCount: measurementsViewModel.weekMeasurements.length,
            itemBuilder: (context,index){
              return Container(
                child: MeasurementsListTile(
                     measurements:  measurementsViewModel.weekMeasurements[index])
              );
          }),
        ],
      )
